  ...
  return (
    <div className=" flex justify-center items-center h-screen">
      ...
      >
        ...
        />
        <div className="mt-10  p-3 text-white rounded-[10px] btn btn-primary">
          Register
        </div>
        <Link to="/login" className="mt-3 text-center font-bold underline text-blue-500">Login Instead</Link>
      </form>
    </div>
  );
};
